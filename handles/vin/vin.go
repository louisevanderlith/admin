...
func GetVIN(mstr *template.Template, tmpl *template.Template) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = ctx.Serve(http.StatusOK, mix.Page("vin", result, ctx.GetTokenInfo(), mstr, tmpl))
...
func ViewVIN(mstr *template.Template, tmpl *template.Template) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = ctx.Serve(http.StatusOK, mix.Page("vinView", result, ctx.GetTokenInfo(), mstr, tmpl))
